...
urlpatterns = [
    ...
    path(
        "rooms/<slug:slug>/", public_views.RoomDetailView.as_view(), name="room_detail"
    ),
    ...
    path(
        "book/search/", public_views.BookingSearchView.as_view(), name="booking_search"
    ),
    path(
        "newsletter/subscribe/",
        public_views.NewsletterSubscribeView.as_view(),
